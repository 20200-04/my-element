  ...
  <div>
    ...
    <div class="publicpage_tableL" style="padding: 10px 5px 10px 10px">
      <table class="table table-striped m-b-none ">
        <thead><tr class="publicpage_tabletrbg">
              <th>代号</th>
              <th>名称</th>
              <th>状态</th>
              <th>数据</th>
  ...
  export default {
    data() {
      return {
        ...
        disabled: false,
        objList: {
          '164B11': {paraID: '164B11', paraName: 'X测控单元定时清零计数', data: 22,time: '2020:04:28 13:03:28', Level: '1级', state: 'ok', original: 'aa'},
          '163B13': {paraID: '163B13', paraName: '遥控注数门开/关状态', data: 33,time: '2020:04:28 13:04:28', Level: '2级', state: 'no', original: 'bb'},
          '164B12': {paraID: '164B12', paraName: '信号处理FPGA加载计数', data: 44,time: '2020:04:28 13:08:28', Level: '3级', state: 'ok', original: 'cc'},
          '163B15': {paraID: '163B15', paraName: '信号处理de加载计数', data: 55,time: '2020:04:28 13:08:28', Level: '4级', state: 'no', original: 'dd'},
          '164B17': {paraID: '164B17', paraName: '信号处理suo加载计数', data: 66,time: '2020:04:28 13:08:28', Level: '5级', state: 'ok', original: 'ee'}
        },
        objCopy: {}
      };
    },
