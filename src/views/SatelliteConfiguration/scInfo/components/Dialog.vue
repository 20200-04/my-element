    ...
    >
      ...
      >
        ...
        <el-form-item label="卫星名称" prop="scName">
          <el-input v-model="form.scName" placeholder="卫星名称" size="mini" style="width: 35%;"></el-input>
        </el-form-item>
        <el-form-item label="卫星代号" prop="scCode">
          <el-input v-model="form.scCode" placeholder="卫星代号" size="mini" style="width: 35%;"></el-input>
        </el-form-item>
        ...
        <el-form-item label="卫星高度" prop="orbitAltitude">
          <el-input v-model="form.orbitAltitude" placeholder="卫星高度" size="mini" style="width: 35%;"></el-input>
        </el-form-item>
