    ...
    >
      ...
      >
        <el-form-item label="方法" prop="funcName">
          <el-input v-model="form.funcName" placeholder="方法" size="mini" style="width: 53%;"></el-input>
        </el-form-item>
  ...
  data() {
    return {
      rules: {
        ...
        funcDescription: [
          { required: true, message: "请选择方法描述", trigger: "change" }
        ],
        paraDescription: [
          { required: true, message: "请选择参数描述", trigger: "change" }
        ]
      }
    };
  },
